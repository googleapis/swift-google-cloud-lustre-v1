...
extension Clients {
  final class LustreLogging: LustreStub {
    let inner: any LustreStub
    let logger: Logger

    public init(_ inner: any LustreStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-lustre-v1"
      logger[metadataKey: "gcp.client.service"] = "lustre"
      logger[metadataKey: "gcp.experimental.swift.client"] = "Lustre"
      self.inner = inner
      self.logger = logger
    }
